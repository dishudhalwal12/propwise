            ...
            {properties.map((property) => {
              ...
              return (
                <div
                  ...
                  className="rounded-[22px] px-4 py-3 text-sm font-semibold text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] transition-transform duration-300 hover:-translate-y-0.5"
                  style={{
